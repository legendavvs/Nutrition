...
const FIELDS = (t) => [
  { key: 'cals', label: t('set.cals'), unit: 'kcal', color: 'text-orange-400', min: 500,  max: 6000, step: 50  },
  { key: 'p',    label: t('set.p'),   unit: 'g',    color: 'text-blue-400',   min: 10,   max: 400,  step: 5   },
  { key: 'f',    label: t('set.f'),       unit: 'g',    color: 'text-yellow-400', min: 10,   max: 300,  step: 5   },
  { key: 'c',    label: t('set.c'),     unit: 'g',    color: 'text-purple-400', min: 10,   max: 800,  step: 10  },
]
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="flex-1 overflow-y-auto px-4 pt-4 pb-6">
        <h2 className="text-xl font-bold text-white mb-1">{t('set.title')}</h2>
        <p className="text-xs text-gray-500 mb-6">{t('set.desc')}</p>
        ...
        <div className="mt-6 bg-[#121212] border border-[#2a2a2a] rounded-2xl p-4">
          <p className="text-xs text-gray-500 mb-1">{t('set.acc')}</p>
